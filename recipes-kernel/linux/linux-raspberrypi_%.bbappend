...
# more details
SRC_URI:append = " ${@oe.utils.conditional('ENABLE_AUDIO', '1', 'file://audio.patch', '', d)}"

SRC_URI:append:raspberrypi4 = " file://0001-Add-rpi4-uart0-dtb-overlay.patch"

do_configure:append:sota() {
    # ramblk for inird
