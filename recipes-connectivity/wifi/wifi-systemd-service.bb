...
do_install () {
    ...
    install -m 0644 ${UNPACKDIR}/26-dhcp-wireless.network ${D}/${systemd_unitdir}/network

    install -d ${D}/${sysconfdir}/wpa_supplicant
    install -m 0600 ${UNPACKDIR}/wpa_supplicant-wlan0.conf ${D}/${sysconfdir}/wpa_supplicant
